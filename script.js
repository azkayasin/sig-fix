...
function execute(){
  ...
  var done= new Promise(function(resolve,reject){
      ...
      var daftarmasjid = document.getElementById("listmasjid");
      var masjidku = daftarmasjid.options[daftarmasjid.selectedIndex].value;
      console.log(masjidku);
      var temp21 = $('#latitude');
  ...
  var done1= new Promise(function(resolve,reject){
      ...
      var oReq = new XMLHttpRequest();
      oReq.onload = reqListener;
      var url="http://localhost/sig/jarak.php?x1="+tempx+"&y1="+tempy+"&masjid="+masjidku;
